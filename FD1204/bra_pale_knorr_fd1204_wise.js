...
var files = fs.readdirSync("C:/Pulse/FD12-04_LOGS/"); //Leer documentos
...
function idle(){
  ...
  for (var k=0;k<files.length;k++){//Verificar los archivos
    var stats = fs.statSync("C:/Pulse/FD12-04_LOGS/"+files[k]);
    ...
    try{
            ...
            //------------------------------------------Filler----------------------------------------------
              ...
              if (FillerflagPrint == 1) {
                for (var key in Fillerresults) {
                  ...
                  fs.appendFileSync('C:/Pulse/FD12-04_LOGS/bra_pou_Filler_FD12-04.log', 'tt=' + Fillertime + ',var=' + key + ',val=' + Fillerresults[key] + '\n');
                }
                FillerflagPrint = 0;
              }
            ...
            //------------------------------------------Cartoner----------------------------------------------
              ...
              if (CartonerflagPrint == 1) {
                for (var key in Cartonerresults) {
                  ...
                  fs.appendFileSync('C:/Pulse/FD12-04_LOGS/bra_pou_Cartoner_FD12-04.log', 'tt=' + Cartonertime + ',var=' + key + ',val=' + Cartonerresults[key] + '\n');
                }
                CartonerflagPrint = 0;
              }
          ...
          client2.on('connect', function(err) {
            ...
            //////--Encoder--------------------------------------------------------------------------------------------------------------------
              ...
              if (EncoderflagPrint == 1) {
                for (var key in Encoderresults) {
                  fs.appendFileSync('C:/Pulse/FD12-04_LOGS/bra_pou_Encoder_FD12-04.log', 'tt=' + Encodertime + ',var=' + key + ',val=' + Encoderresults[key] + '\n');
                }
                EncoderflagPrint = 0;
              }
            //////--Encoder--------------------------------------------------------------------------------------------------------------------
            //////--CasePacker--------------------------------------------------------------------------------------------------------------------
              ...
              if (CasePackerflagPrint == 1) {
                for (var key in CasePackerresults) {
                  ...
                  fs.appendFileSync('C:/Pulse/FD12-04_LOGS/bra_pou_CasePacker_FD12-04.log', 'tt=' + CasePackertime + ',var=' + key + ',val=' + CasePackerresults[key] + '\n');
                }
            ...
            //////--CasePacker--------------------------------------------------------------------------------------------------------------------
               ...
               //////--EOL--------------------------------------------------------------------------------------------------------------------
            if(secEOL>=60){
              fs.appendFileSync("C:/Pulse/FD12-04_LOGS/bra_pou_EOL_FD12-04.log","tt="+Date.now()+",var=EOL"+",val="+eol+"\n");
